...
from bokeh.models import (Label, Span, LinearAxis, Range1d, Whisker, ColumnDataSource, BasicTicker, Tabs,
                          TabPanel, RangeSlider, CustomJS, Button, NumeralTickFormatter, ScientificFormatter)
...
class plot_eflux_phase():
    ...
    def output_plot(self):
        ...
        slider_A.format = NumeralTickFormatter(use_scientific=True)  # Set format to scientific notation
