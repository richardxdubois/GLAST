...
u_hist = figure(title="super 1-2 flux vs phase", x_axis_label='Orbital Phase', width=750)
...
v_hist = figure(title="super 3-9,0 flux vs phase", x_axis_label='Orbital Phase', width=750)
